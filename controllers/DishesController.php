...
class DishesController extends BaseController
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->saveDishWithIngredients()) {
            return $this->redirect(['view', 'id' => $model->id_dishes]);
        }
    ...
    {
        if (($model = Dishes::getDish($id)) !== null) {
            return $model;
        }
